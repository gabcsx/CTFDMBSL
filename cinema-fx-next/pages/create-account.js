...
export default function CreateAccount() {
                ...
                <section className="account-creation">
                    ...
                    <form id="createAccountForm" onSubmit={handleSubmit} noValidate>
                        ...
                        <div className="form-group">
                            ...
                            />
                            <span id="addressError" className="error-message" aria-live="polite">
                                {errors.address}
                            </span>
                        </div>
  ...
  maxLength={11}    // max length 11 characters
  inputMode="numeric" // mobile numeric keyboard
/>
                            <span id="phoneError" className="error-message" aria-live="polite">
                                {errors.phone}
                            </span>
                        </div>
